    ...
    return Container(
      ...
      child: Consumer<Currencies>(
        builder: (context, currencies, child) {
          return currencies.currencies.isEmpty
              ? Center(
                  child: Text(
                    "Add Currency to track".toUpperCase(),
                    style:
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Dismissible(
                      key: ValueKey(currencies.currencies[index].id),
                        ...
                        return showDialog(
                            ...
                            builder: (context) {
                              return AlertDialog(
                                ...
                                content: Text(
                                    'Do you want to untrack the cryptocurrency?',
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      currencies
                                          .currencies[index].cryptoInfo.symbol
                                          .toUpperCase(),
                                    ...
                                    Text(
                                      currencies
                                          .currencies[index].cryptoInfo.name
                                          .toUpperCase(),
                                      style: GoogleFonts.poppins(
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  currencies.currencies[index].cryptoInfo
                                      .currentPrice,
                                  style: GoogleFonts.poppins(
